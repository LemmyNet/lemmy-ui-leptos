...
// TODO: See if server functions compile correctly after upgrade to version 0.5.0
...
pub fn LoginForm(cx: Scope) -> impl IntoView {
  ...
  // TODO: Replace wrapping div with ActionForm once server functions work
  // let login = create_server_action::<LoginForm>(cx);

  view! { cx,
    <div  class="mx-auto w-full lg:w-1/3 space-y-3">
      // {move || {
